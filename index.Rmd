---
title: "Revisiting Toronto Transit Commission Data"
subtitle: ""
...
streetcar.df %>%
  ...
  geom_text(aes(x=reorder(Incident,n),y=I((n/sum(n))*100),label=round((n/sum(n))*100,1),hjust=+1.2),colour="black")+
  theme_ai()+
  labs(title="Over half of reported subway incidents are due to\nmechanical failures",
